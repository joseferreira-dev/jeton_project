 ...
 * de Utilizadores e Níveis de Acesso entre a camada de Serviço e a camada de
 * Apresentação (Controladores).
 * NOTA: Esta classe não é uma Entidade JPA, não tem reflexo direto na base de
 * dados.
 */

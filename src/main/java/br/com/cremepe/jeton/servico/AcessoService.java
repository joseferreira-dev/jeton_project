...
public class AcessoService {
    ...
    /**
     * Atribui um novo perfil de acesso a um utilizador salvando a entidade com as
     * amarrações relacionais.
     */
    @Transactional
    public UsuarioAcesso concederPermissao(Integer idUsuario, String idNivel) {
        ...
        return usuarioAcessoRepository.findById(idComposto).orElseGet(() -> {
            ...
            // CORREÇÃO: Busca as entidades correspondentes para preencher os mapeamentos do
            // @MapsId

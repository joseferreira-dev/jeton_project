...
public interface LogJetonRepository extends JpaRepository<LogJeton, Integer> {
    ...
    // Extrai a trilha de auditoria de um utilizador específico, do mais recente para o mais antigo
    List<LogJeton> findByUsuarioIdUsuarioPessoaOrderByDataHoraLogDesc(Integer idUsuario);

    // Permite varrer a base de dados em busca de alterações feitas numa tabela específica 
